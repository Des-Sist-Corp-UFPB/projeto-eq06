# Ideia de Servidor MCP — EQ06

**Domínio:** E-commerce com chat IA (Gemini), produtos e favoritos  
**Data:** 2026-07-01
...
## Servidor proposto: `mercado-mcp`

### Tools sugeridas

- `buscar_produto(query)` — busca produtos
- `adicionar_favorito(userId, produtoId)` — favorita
- `historico_mensagens(userId)` — recupera conversa

### Resources (somente leitura)

- catálogo de produtos como resource

### Exemplos de uso com um LLM

- "Procure fones bluetooth abaixo de R$200 e favorite o mais bem avaliado."
...
@Service
public class MercadoTools {

    private final SeuService seuService;   // injete seus services/repositories

    public MercadoTools(SeuService seuService) { this.seuService = seuService; }

    @Tool(description = "busca produtos")
    public Object buscar_produto(/* params */) {
